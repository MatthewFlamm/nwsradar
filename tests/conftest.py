...
def mock_nwsradar():
    ...
    with patch("custom_components.nwsradar.Nws_Radar", autospec=True) as mock_nwsradar:
        yield mock_nwsradar
...
def mock_nwsradar_lite():
    """Mock nwsradar classes with default values."""
    with patch(
        "custom_components.nwsradar.Nws_Radar_Lite", autospec=True
...
def mock_nwsradar_mosaic():
    """Mock nwsradar classes with default values."""
    with patch(
        "custom_components.nwsradar.Nws_Radar_Mosaic", autospec=True
